...
## 1) This modelling procedure follows a similar method of modeling a combustor as in Douglas L. Allaire's thesis. It consists of 10-19 PSRs in the radial
##    direction in primary zone. This distribution of PSRs is based on an assumed normal distribution of equivalence ratio in the PZ. Several values of
##    unmixedness parameter were tried to observe the relationship between fuel/air unmixedness and the accuracy in prediction of emissions.
