...
## 1) This model consists of 10-19 PSRs in the radial direction in primary zone. This distribution of PSRs is based on an assumed normal distribution of equivalence ratio in the PZ. Several values of
